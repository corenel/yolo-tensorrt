...
int main() {
  ...
  config_v3.net_type = yolo_trt::ModelType::PYOLOV3;
  ...
  config_v3.inference_precison = yolo_trt::Precision::FP32;
  ...
  config_v3_tiny.calibration_image_list_file_txt =
      "../configs/calibration_images.txt";
  config_v3_tiny.inference_precison = yolo_trt::Precision::FP32;
  ...
  config_v4.calibration_image_list_file_txt =
      "../configs/calibration_images.txt";
  config_v4.inference_precison = yolo_trt::Precision::INT8;
  ...
  config_v4_tiny.calibration_image_list_file_txt =
      "../configs/calibration_images.txt";
  config_v4_tiny.inference_precison = yolo_trt::Precision::FP32;
  ...
  config_v5.inference_precison = yolo_trt::Precision::FP32;

  std::unique_ptr<yolo_trt::Detector> detector(new Detector());
